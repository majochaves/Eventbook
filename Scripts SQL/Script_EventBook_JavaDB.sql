...
-- Nombre usuario: admin. Contrasenya: 123
INSERT INTO USUARIO (NOMBRE, APELLIDOS, DOMICILIO, CIUDAD_RESIDENCIA, PASSWORD, USERNAME, SEXO, FECHA_CREACION) 
	VALUES ('NombreAdmin', 'ApellidoAdmin', 'UMA', 'Malaga', '123', 'admin', 'hombre', CURRENT_DATE);

INSERT INTO ADMINISTRADOR (USUARIO_ID) 
	VALUES (1);

INSERT INTO ANALISTA (USUARIO_ID) 
	VALUES (1);

INSERT INTO CREADOREVENTOS (USUARIO_ID) 
	VALUES (1);

INSERT INTO TELEOPERADOR (USUARIO_ID) 
	VALUES (1);

INSERT INTO USUARIOEVENTOS (USUARIO_ID) 
	VALUES (1);
