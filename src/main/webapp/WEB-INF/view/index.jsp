    ...
    <div class="page">
      <!--RD Navbar-->
        <jsp:include page="header.jsp">
            <jsp:param name="nav" value="inicio"/>  
        </jsp:include>
      <!-- Intro-->
                ...
                <div class="col-md-10 col-lg-8 col-xl-7 col-xxl-6" data-animate='{"class":"fadeInUp"}'>
                    ...
                    %>
                            <div class="offset-md group-30">
                                <a class="btn btn-lg btn-primary" href="/login">¿Ya tienes una cuenta?</a>
                                <a class="btn btn-lg btn-secondary" href="/register">¡Únete a nosotros!</a>
                            </div>
                    <%
                          }
                    %>
