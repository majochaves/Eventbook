...
<section class="section section-lg bg-transparent">
    <div class="container ChatContainer clearfix">
        ...
        <div class="chat">
            ...
            <div class="chat-message clearfix row" style="margin: 1rem;">
...
//                                             $('.chat-history').find('ul').append(xmlhttp.responseText);
                                        ...
                                        <%
                                            UsuarioDTO user = (UsuarioDTO) request.getAttribute("usuarioChat");
                                            UsuarioDTO user2 = (UsuarioDTO) request.getAttribute("usuarioChat2");
                                        %>
