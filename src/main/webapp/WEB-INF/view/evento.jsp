              ...
              <div class="container">
                <div class="row justify-content-center">
                  <div data-animate='{"class":"fadeInUp"}'>
                      <h1><%= editar ? "Editar evento " + evento.getId(): "Crear un nuevo evento" %></h1>
                      <%if(strError != null){%>
                          <p><%=strError%></p>
                      <%}%>
                      <form:form method="POST" action="/eventoGuardar" modelAttribute="evento">
                          ...
                          <div class="form-group">
                              ...
                              <form:select class="form-control" path="etiquetaList" multiple="true" items="${etiquetaList}" itemLabel="descripcion"/>
                          </div>
                          <div class="form-group">
                              <label>Asientos fijos:</label>
                              <form:radiobutton path="asientosFijos" id="asientosFijosSi" value="S" checked="<%=selectedAFSi%>"/>Si
                              <form:radiobutton path="asientosFijos" id="asientosFijosNo" value="N" checked="<%=selectedAFNo%>"/>No
                          </div>
                          ...
                          <div class="row">
                              ...
                              <div class="col-8">
                                  <input class="btn btn-primary btn-block" type="submit" value="<%= editar ? "Confirmar cambios" : "Crear evento" %>"/>
                              </div>
                          </div>
                      </form:form>
                  </div>
