...
<head>
    ...
    <link rel="stylesheet" href="/components/propios/extraGraficas.css">
    <script>
        ...
        <jsp:include page="./header.jsp">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    ...
                    %>
                    <div class="col-10 col-md-8 col-xl-5 mb-5 ml-5 mr-5 mt-5 shadow-lg p-3 mb-5 fondoPrue rounded border">
